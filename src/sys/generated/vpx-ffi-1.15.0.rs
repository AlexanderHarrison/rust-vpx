...
pub const VPX_EXT_RATECTRL_ABI_VERSION: u32 = 9;
...
pub const VPX_ENCODER_ABI_VERSION: u32 = 36;
...
pub enum vp8e_enc_control_id {
    ...
    VP9E_SET_TPL = 65,
    VP9E_SET_KEY_FRAME_FILTERING = 66,
    VP9E_SET_POSTENCODE_DROP = 67,
    VP9E_SET_DELTA_Q_UV = 68,
    VP9E_SET_DISABLE_OVERSHOOT_MAXQ_CBR = 69,
    VP9E_SET_DISABLE_LOOPFILTER = 70,
    VP9E_SET_EXTERNAL_RATE_CONTROL = 71,
    VP9E_SET_RTC_EXTERNAL_RATECTRL = 72,
    VP9E_GET_LOOPFILTER_LEVEL = 73,
    VP9E_GET_LAST_QUANTIZER_SVC_LAYERS = 74,
    VP8E_SET_RTC_EXTERNAL_RATECTRL = 75,
    VP9E_SET_QUANTIZER_ONE_PASS = 76,
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
